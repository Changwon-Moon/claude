...
renderLineCard({
  ...
  DISP: {
    "노원":"포레나노원","창동":"동아청솔","미아사거리":`미아동부${Z}센트레빌`,"길음":`롯데캐슬${Z}클라시아`,
    "성신여대입구":"돈암 코오롱하늘채","삼각지":`용산${Z}e편한세상`,"이촌":"한가람",
    "이수":`이수푸르지오${Z}더프레티움`,"사당":"사당우성2","과천":`과천푸르지오${Z}써밋`,"인덕원":"인덕원마을 삼성",
    "평촌":`평촌더샵${Z}센트럴시티`,"범계":`평촌센텀${Z}퍼스트`,"금정":`힐스테이트${Z}금정역`,"산본":`래미안${Z}하이어스`,
    "안산중앙":`안산레이크타운${Z}푸르지오`,
  },
  GUC: {"노원구":"#E4572E","도봉구":"#CA8A04","강북구":"#9A3412","성북구":"#7C3AED","용산구":"#DB2777","동작구":"#0E9AA7","과천":"#16A34A","안양":"#2563EB","군포":"#64748B","안산":"#0D9488"},
});

...
const card = {
  ...
  head: { c: ["순위", "지역", "월세 상승분"] },
  /* 오너 지시(2026-07-30): 기준 시점을 제목 아래·표 오른쪽·지도 위에, 제목 절반 크기 회색으로.
   * 문자열을 손으로 적지 않는다 — asOf 가 바뀌면 이 줄도 따라 바뀐다. */
  asOfNote: `${asOf.slice(0, 4)}년 ${Number(asOf.slice(5))}월 말 기준`,
  mapSvg,
  rows,

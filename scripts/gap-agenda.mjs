...
L.push("- **구 중복 회피는 「한 카드 안에서만」입니다** (오너 2026-09-03 명확화).");
L.push("  한 장 안에 같은 행정구가 두 번 들어가지 않게 하는 것이 전부이고, 코드가 이미 그렇게 뽑습니다.");
L.push("  **앞 카드에 나온 구를 다음 카드에서 피하지 않습니다** — 성동·성북·분당은 실제로 가장 많이 오른 구라서,");
L.push("  그걸 피하면 「가장 많이 갈린 곳」을 보여 주는 시리즈가 덜 갈린 것들로 채워집니다.");

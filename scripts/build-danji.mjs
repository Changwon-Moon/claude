...
function marginBand(d) {
  ...
  /* `margin.digits: 2` 는 검산이 맞아도 둘째 자리로 적는다 — 14.25억 거래를 14.3억이라 적으면
     실거래를 부풀린다(철산자이 더 헤리티지 2026-09-17). 기본은 예전 그대로다. */
  const eok2 = (v) => `${(v / 1e8).toFixed(2)}억`;
  const fmt = m.digits === 2 ? eok2 : r1(m.market.won) - r1(priceWon) === r1(gap) ? eok1 : eok2;

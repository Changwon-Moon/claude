...
/* ⚠️ 최상위 문서를 빠뜨리면 안 된다 — 세션 규칙과 문서 지도가 둘 다 CLAUDE.md 에 있다.
   2026-08-31 에 preview-html.mjs 를 CLAUDE.md §3 에 등재했는데도 계속 고아로 잡혔다.
   검사가 **정본을 안 보고 있었다.** */
const HAYSTACK_ROOT_FILES = ["CLAUDE.md", "STATUS.md", "README.md"];

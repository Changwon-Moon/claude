...
const card = {
  ...
  cols,
  rows,
  /* 조사 종류가 무엇을 재는지 — 표의 회색 칩과 같은 말을 풀어 쓴다.
   * 손으로 적는 문장이지만 각 조사의 kind 와 어긋나면 안 되므로 kind 를 그대로 키로 쓴다. */
  notes: [
    { k: "설문", v: "사람에게 직접 물은 인지도·선호도. 오래 알려진 브랜드가 유리합니다." },
    { k: "빅데이터", v: "온라인에서 얼마나 언급됐나. 분양·이슈가 많은 달에 올라갑니다." },
    { k: "지수", v: "브랜드 주가 70% + 소비자조사 30%을 섞은 값입니다." },
  ],
  caveat: "부동산R114·여론조사는 2025년 조사입니다(2026년판 미발표).",

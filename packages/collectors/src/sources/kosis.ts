...
export const TABLES: Record<string, TableSpec> = {
  ...
  wageYearEnd: {
    ...
    confidence: "표명확실", enabled: false,
    note: "미검증(2026-09-14 등록). 총급여액 규모별 신고인원을 여기서 뽑는다. " +
      "축이 '총급여액 규모'인지, 1억 초과 구간이 한 칸인지 여러 칸의 합인지 probe 로 본다.",
  },
  ...
  populationYear: {
    ...
    confidence: "표명확실", enabled: false,
    note: "미검증(2026-09-14 등록). population 과 같은 표를 prdSe=Y · 전국(00)으로 부른다. " +
      "objL1='00' 이 전국인지, 연간 수록이 어느 해부터인지 probe 로 확인한다.",
  },
};

...
export const TABLES: Record<string, TableSpec> = {
  ...
  wageBracket: {
    ...
    metric: "근로소득자", itmId: "ALL", objL1: "ALL", objL2: "", prdSe: "Y",
    confidence: "표명확실", enabled: false,
    note: "미검증(2026-09-14 등록). 억대 연봉 근로소득자 인원을 여기서 센다. " +
      "probe 로 확인할 것: 규모 구간이 어느 축인지 · 1억 초과가 한 칸인지 여러 칸 합인지 · " +
      "주소지 축에 '전국' 합계가 있는지(없으면 시도를 더해야 한다) · 2009년까지 거슬러 가는지. " +
      "대조값: 2023년 139만명(6.7%) · 2024년 154만5,725명(7.3%).",
  },

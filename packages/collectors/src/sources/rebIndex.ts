 ...
 * 서울 25개 자치구 — **코드로 못박는다.**
 *
 * ── 왜 목록을 하드코딩하나 (2026-07-30)
 * "530 으로 시작하면 서울 자치구" 라고 자르면 **경기가 섞인다.** R-ONE 의 530 대역에는
 * 분당구·영통구·수지구·일산동구·동탄구 등 경기 시·구 24곳이 함께 들어 있다.
 * 실제로 그렇게 자른 첫 계산에서 서울 25곳 순위표에 경기 24곳이 섞여
 * **1위가 영통구(경기 수원)** 로 나왔다. 서울 랭킹 카드에 경기가 섞인 사고를 이미 겪었고,
 * 접두사 규칙은 그 사고를 다시 부른다.
 * 그래서 **규칙이 아니라 명단**을 둔다. 명단은 틀리면 눈에 보이고, 규칙은 조용히 틀린다.
 *
 * 빠진 번호(530014·530023·530027·530028·530036 등)는 R-ONE 이 쓰지 않는 결번이다.
 */
export const SEOUL_GU_CODES = [
  "530011", // 종로구
  "530012", // 중구 — ⚠️ 동명 구가 부산·대구·인천·대전·울산에도 있다. 코드로만 집는다
  "530013", // 용산구
  "530015", // 성동구
  "530016", // 광진구
  "530017", // 동대문구
  ...
  "530026", // 마포구
  "530029", // 양천구
  "530030", // 강서구 — ⚠️ 부산에도 강서구가 있다(520078)
  "530031", // 구로구
  "530032", // 금천구
  "530033", // 영등포구
  "530034", // 동작구

...
- 실행: 2026-09-11 (KST) · 방아쇠 `workflow_run` · **자동 재시도** 1/4칸 · 🔇 조용
...
 ERR_PNPM_RECURSIVE_RUN_FIRST_FAIL  @wirit/collectors@0.1.0 collect-singo: `tsx src/molitSingoCli.ts -- --today 2026-09-11 --months 2 --top 0 --sort price`
Exit status 1
```

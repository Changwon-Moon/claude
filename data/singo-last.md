...
- 실행: 2026-09-14 (KST) · 방아쇠 `workflow_run` · **자동 재시도** 1/4칸 · 🔇 조용
- 기준: 1000세대 이상 명부 · 전용 59·84 타입 · 최근 2개월 신고분
- 결과: **실패**
- 커밋: `236e94552f5dc4514a3b1d91bf9ac2840da844d4`

```

> @wirit/collectors@0.1.0 collect-singo /home/runner/work/claude/claude/packages/collectors
> tsx src/molitSingoCli.ts -- --today 2026-09-14 --months 2 --top 0 --sort price
...
 ERR_PNPM_RECURSIVE_RUN_FIRST_FAIL  @wirit/collectors@0.1.0 collect-singo: `tsx src/molitSingoCli.ts -- --today 2026-09-14 --months 2 --top 0 --sort price`
Exit status 1
```

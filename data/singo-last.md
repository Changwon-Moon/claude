...
- 실행: 2026-09-03 (KST) · 방아쇠 `workflow_run` · **자동 재시도** 1/3칸 · 🔇 조용
- 기준: 1000세대 이상 명부 · 전용 59·84 타입 · 최근 2개월 신고분
- 결과: **실패**
- 커밋: `64b00524d76893b6bb74449372c83c5211c0819d`
...
 ERR_PNPM_RECURSIVE_RUN_FIRST_FAIL  @wirit/collectors@0.1.0 collect-singo: `tsx src/molitSingoCli.ts -- --today 2026-09-03 --months 2 --top 0 --sort price`
Exit status 1
```

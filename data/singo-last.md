...
- 결과: **실패**
- 커밋: `b35de646592c2f00e07aceca05493c0427f1f590`
...
 ERR_PNPM_RECURSIVE_RUN_FIRST_FAIL  @wirit/collectors@0.1.0 collect-singo: `tsx src/molitSingoCli.ts -- --today 2026-09-10 --months 2 --top 0 --sort price`
Exit status 1
```

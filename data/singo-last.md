...
- 실행: 2026-08-24 (KST) · 방아쇠 `workflow_dispatch`
- 기준: 1000세대 이상 명부 · 전용 59·84 타입 · 최근 1개월 신고분
- 결과: **실패**
- 커밋: `a67df2f40117aa3b18e88e968e27ae19fd66b70d`

```

> @wirit/collectors@0.1.0 collect-singo /home/runner/work/claude/claude/packages/collectors
> tsx src/molitSingoCli.ts -- --today 2026-08-24 --months 1 --top 0 --sort price
...
명부 1147개 단지 · 판정 지역 18/61 · 수집 성공 0회 / 실패 18회
→ 오늘의 신고가 0건
...
 ERR_PNPM_RECURSIVE_RUN_FIRST_FAIL  @wirit/collectors@0.1.0 collect-singo: `tsx src/molitSingoCli.ts -- --today 2026-08-24 --months 1 --top 0 --sort price`
Exit status 1
```

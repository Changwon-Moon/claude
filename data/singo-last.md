...
- 실행: 2026-09-06 (KST) · 방아쇠 `schedule`
- 기준: 1000세대 이상 명부 · 전용 59·84 타입 · 최근 2개월 신고분
- 결과: **실패**
- 커밋: `c5846a1209f28098438053201ec46bf8154fe238`

```

> @wirit/collectors@0.1.0 collect-singo /home/runner/work/claude/claude/packages/collectors
> tsx src/molitSingoCli.ts -- --today 2026-09-06 --months 2 --top 0 --sort price
...
 ERR_PNPM_RECURSIVE_RUN_FIRST_FAIL  @wirit/collectors@0.1.0 collect-singo: `tsx src/molitSingoCli.ts -- --today 2026-09-06 --months 2 --top 0 --sort price`
Exit status 1
```

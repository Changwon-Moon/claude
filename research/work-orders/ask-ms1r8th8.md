# 작업지시 — 전세가율 지도, 전세난 정도 등 전세와 관련된 데이터 시각화 소재들 찾아줘

> 오너가 관제탑에서 승인한 소재입니다. 이 문서가 제작의 출발점입니다.
> 생성: 자동 (scripts/open-work-orders.mjs) · 소재 id `ask-ms1r8th8` · 승인 26.07.26(일)

## 소재

| | |
|---|---|
| 제목 | 전세가율 지도, 전세난 정도 등 전세와 관련된 데이터 시각화 소재들 찾아줘 |
| 분류 | ✅ 제작 완료 · 발행 대기 |
| 왜 이 소재인가 | 오너 직접 입력 |
| 데이터 출처 | 지시함 |
